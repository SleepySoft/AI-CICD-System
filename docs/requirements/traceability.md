...
| FR-MGR-017 | 分角色鉴权与可插拔鉴权后端 | what/manager.md §权限规格 | chronicler/app/auth.py + chronicler/app/routers/users.py（ADR-0020/0023） | scripts/verify-chronicler.sh（401 检查） |
